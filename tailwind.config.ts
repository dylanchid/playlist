...
export default {
  ...
  theme: {
    extend: {
      colors: {
        ...
        soundcloud: {
          orange: {
            ...
            300: '#fdba74',
            400: '#fb923c',
            500: '#ff5500', // Main SoundCloud orange
            600: '#ea580c',
            700: '#c2410c',
            800: '#9a3412',
            900: '#7c2d12',
      ...
      backgroundImage: {
        'soundcloud-gradient': 'linear-gradient(135deg, #ff5500 0%, #ff8f00 50%, #ffb347 100%)',
        'waveform-gradient': 'linear-gradient(to top, #ff5500, #ff8f00)',
      },
      animation: {
